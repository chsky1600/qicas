    ...
    academic_years: [
      {
        ...
        instructor_rules: [
          ...
          { id: "ir-7", instructor_id: "inst-7", designations: [], workload_delta: 0, courses: [], declined_courses: [], dropped: false },
        ],
        ...
        course_rules: [
          ...
          { id: "cr-2", course_code: "CISC204", terms_offered: ["Fall"], workload_fulfillment: 1, is_full_year: false, sections_available: ["s-7"], is_external: false, dropped: false },
          { id: "cr-3", course_code: "CISC490", terms_offered: ["Fall", "Winter"], workload_fulfillment: 2, is_full_year: true, sections_available: ["s-8"], is_external: false, dropped: false },
          { id: "cr-4", course_code: "CISC890", terms_offered: ["Winter"], workload_fulfillment: 1, is_full_year: false, sections_available: ["s-9"], is_external: false, dropped: false },
          { id: "cr-5", course_code: "MATH110", terms_offered: ["Fall", "Winter"], workload_fulfillment: 1, is_full_year: false, sections_available: ["s-10"], is_external: true, dropped: false },
          { id: "cr-6", course_code: "CISC121", terms_offered: ["Fall", "Winter"], workload_fulfillment: 1, is_full_year: false, sections_available: ["s-4"], is_external: false, dropped: false },
          { id: "cr-7", course_code: "CISC124", terms_offered: ["Fall", "Winter"], workload_fulfillment: 1, is_full_year: false, sections_available: ["s-5"], is_external: false, dropped: false },
          { id: "cr-8", course_code: "CISC203", terms_offered: ["Fall", "Winter"], workload_fulfillment: 1, is_full_year: false, sections_available: ["s-6"], is_external: false, dropped: false },
        ],
      },
    ],
  };
