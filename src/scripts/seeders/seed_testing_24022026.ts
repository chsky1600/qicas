    ...
    academic_years: [
      {
        ...
        course_rules: [
          { id: "cr-1", course_code: "CISC101", terms_offered: ["Fall", "Winter"], workload_fulfillment: 1, is_full_year: false, sections_available: ["001", "002", "003"], is_external: false },
          { id: "cr-2", course_code: "CISC204", terms_offered: ["Fall"], workload_fulfillment: 1, is_full_year: false, sections_available: ["001"], is_external: false },
          { id: "cr-3", course_code: "CISC490", terms_offered: ["Fall", "Winter"], workload_fulfillment: 2, is_full_year: true, sections_available: ["001"], is_external: false },
          { id: "cr-4", course_code: "CISC890", terms_offered: ["Winter"], workload_fulfillment: 1, is_full_year: false, sections_available: ["001"], is_external: false },
          { id: "cr-5", course_code: "MATH110", terms_offered: ["Fall", "Winter"], workload_fulfillment: 1, is_full_year: false, sections_available: ["001"], is_external: true },
          { id: "cr-6", course_code: "CISC121", terms_offered: ["Fall", "Winter"], workload_fulfillment: 1, is_full_year: false, sections_available: ["001"], is_external: false },
          { id: "cr-7", course_code: "CISC124", terms_offered: ["Fall", "Winter"], workload_fulfillment: 1, is_full_year: false, sections_available: ["001"], is_external: false },
          { id: "cr-8", course_code: "CISC203", terms_offered: ["Fall", "Winter"], workload_fulfillment: 1, is_full_year: false, sections_available: ["001"], is_external: false },
        ],
      },
    ],
  };
